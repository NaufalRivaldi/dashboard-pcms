...
@section('card-content')
    <!-- Start - Detail siswaCuti -->
    <div class="row">
        <div class="col-sm-3 font-weight-bold">Kode Cabang</div>
        <div class="col-sm-1 text-right">:</div>
        <div class="col-sm-8">{{ $siswaCuti->cabang->kode }}</div>
    </div>
    <div class="row mt-2">
        <div class="col-sm-3 font-weight-bold">Nama Cabang</div>
        <div class="col-sm-1 text-right">:</div>
        <div class="col-sm-8">{{ $siswaCuti->cabang->nama }}</div>
    </div>
    <div class="row mt-2">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalValidationLabel">Verifikasi Data siswa Cuti</h5>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            accept: function(){
                // ----------------------------------------------------------------
                let url = "{{ route('import.la11.show.accept', ':id') }}";
                url = url.replace(':id', "{{ $siswaCuti->id }}");
