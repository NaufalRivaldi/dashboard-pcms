<div class="row">
    <div class="col-md-12 text-center">
        <h6>
            PERBANDINGAN SUMMARY LAPORAN SISWA AKTIF BERDASARKAN PENDIDIKAN<br>
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th colspan="2" v-for="(value, index) in chartSiswaAktifPendidikan.dataSets">
                            @{{ value.label }}
                        </th>
                    </tr>
                    <tr>
                        <template colspan="2" v-for="(value, index) in chartSiswaAktifPendidikan.dataSets">
                ...
                <tbody>
                    <tr v-for="(label, index) in labels">
                        ...
                        <template v-for="(value, indexSiswa) in chartSiswaAktifPendidikan.dataSets">
                            <td align="right" v-if="index % 2 == 0">
                                @{{ chartSiswaAktifPendidikan.dataSets[indexSiswa].data[index] | numeral('0,0') }}
                            </td>
                            <td align="right" v-if="index % 2 == 0">
                                @{{ chartSiswaAktifPendidikan.dataSets[indexSiswa].data[index+1] | numeral('0,0') }}
                            </td>
                        </template>
                    </tr>
                    <tr>
                        ...
                        <template v-for="(value, indexSiswa) in chartSiswaAktifPendidikan.dataSets">
                            <th class="text-right">
                                @{{ sumBy(chartSiswaAktifPendidikan.dataSets[indexSiswa].data, 0) | numeral('0,0') }}
                            </th>
                            <th class="text-right">
                                @{{ sumBy(chartSiswaAktifPendidikan.dataSets[indexSiswa].data, 1) | numeral('0,0') }}
                            </th>
                        </template>
                    </tr>
                </tbody>
