...
@section('card-content')
    ...
    <template v-else>
        ...
        @include('backend.report.all.includes.chart-penerimaan')
        <!-- End - Analisis chart royalti -->

        <hr>

        <!-- Start - Analisis chart royalti -->
        @include('backend.report.all.includes.chart-royalti')
        <!-- End - Analisis chart royalti -->

        <hr>

        <!-- Start - Analisis chart siswa -->
        @include('backend.report.all.includes.chart-siswa')
        <!-- End - Analisis chart siswa -->

        <hr>

        <!-- Start - Analisis chart siswa-jurusan -->
        @include('backend.report.all.includes.chart-siswa-jurusan')
        <!-- End - Analisis chart siswa-jurusan -->

        <hr>

        <!-- Start - Analisis chart siswa-pendidikan -->
        @include('backend.report.all.includes.chart-siswa-pendidikan')
    ...
    new Vue({
        ...
        methods: {
            ...
            search: function(){
                ...
                // ----------------------------------------------------------------
                let request = axios.post("{{ route('main.report.all.search') }}", data);
                // ----------------------------------------------------------------
            ...
            exportData: function(){
                ...
                let sub_wilayah_id   = $("select[name='sub_wilayah_id']").val();
                // ----------------------------------------------------------------
                let url = "{{ route('main.report.all.export') }}?start_date="+startDate+"&end_date="+endDate+"&start_year="+startYear+"&end_year="+endYear+"&cabang_id="+cabang_id+"&wilayah_id="+wilayah_id+"&sub_wilayah_id="+sub_wilayah_id;
                // ----------------------------------------------------------------
