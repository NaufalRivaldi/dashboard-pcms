    ...
    new Vue({
        ...
        methods: {
            ...
            search: function(){
                ...
                // ----------------------------------------------------------------
                let request = axios.post("{{ route('main.report.under5.search') }}", data);
                // ----------------------------------------------------------------
            ...
            exportData: function(){
                ...
                let periodeTahun   = $("select[name='periodeTahun']").val();
                // ----------------------------------------------------------------
                let url = "{{ route('main.report.under5.export') }}?periode_bulan="+periodeBulan+"&periode_tahun="+periodeTahun;
                // ----------------------------------------------------------------
