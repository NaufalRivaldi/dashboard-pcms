...
@section('card-button')
    <a href="{{ route('master.wilayah.create') }}" class="btn btn-info"><i class="ti-plus"></i> Add data</a>
@endsection
    ...
    new Vue({
        ...
        methods: {
            ...
            setStatus: function(type, id){
                // ----------------------------------------------------------------
                let url = "{{ route('master.wilayah.update.status', ['type' => ':type', 'id' => ':id']) }}";
