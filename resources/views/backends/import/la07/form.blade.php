...
<form action="{{ $siswaAktif->id == null ? route('import.la07.store') : route('import.la07.update', $siswaAktif->id) }}" method="POST">
    @csrf
    ...
    <!-- Start - Row 1 -->
    @include('backend.import.la07.includes.row-1.input')
    <!-- End - Row 1 -->
    ...
    <template v-if="status.form">
        ...
        <!-- Start - Row 2 -->
        @include('backend.import.la07.includes.row-2.input')
        <!-- End - Row 2 -->
    ...
    new Vue({
        ...
        methods: {
            ...
            checkDataValidation: function(){
                ...
                // ----------------------------------------------------------------
                let request = axios.get("{{ route('import.la07.check-data-validation') }}", {
                                params: data
                            });
                // ----------------------------------------------------------------
