...
@section('card-button')
    <a href="{{ route('import.la11.import') }}" class="btn btn-success"><i class="ti-file"></i> Import Data</a>
    <a href="{{ route('import.la11.create') }}" class="btn btn-info"><i class="ti-plus"></i> Add data</a>
@endsection
    ...
    new Vue({
        ...
        methods: {
            ...
            deleteData: function(id){
                // ----------------------------------------------------------------
                let url = "{{ route('import.la11.destroy', ':id') }}";
