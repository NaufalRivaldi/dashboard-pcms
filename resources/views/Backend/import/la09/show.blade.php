...
@section('card-button')
    <a href="{{ route('import.la09.show.pdf', $siswaBaru->id) }}" class="btn btn-danger  @if($siswaBaru->status == 0) disabled @endif"><i class="ti-file"></i> Export PDF</a>

    @if($siswaBaru->status == 0)
...
@section('card-content')
    ...
    <div class="row mt-2">
        ...
        <div class="col-sm-1 text-right">:</div>
        <div class="col-sm-8">{{ setMonth($siswaBaru->bulan) }}</div>
    </div>
    <div class="row mt-2">
    ...
    <div class="row mt-2">
        ...
        <div class="col-sm-1 text-right">:</div>
        <div class="col-sm-8">{!! statusValidate($siswaBaru->status) !!}</div>
    </div>
    <div class="row mt-2">
        <div class="col-sm-3 font-weight-bold">Jumlah Total Siswa Baru</div>
        <div class="col-sm-1 text-right">:</div>
        <div class="col-sm-8">{{ $siswaBaru->jumlah }} Orang</div>
    </div>
