...
@section('card-button')
    <a href="{{ route('import.la09.import') }}" class="btn btn-success"><i class="ti-file"></i> Import Data</a>
    <a href="{{ route('import.la09.create') }}" class="btn btn-info"><i class="ti-plus"></i> Add data</a>
@endsection
    ...
    new Vue({
        ...
        methods: {
            ...
            deleteData: function(id){
                // ----------------------------------------------------------------
                let url = "{{ route('import.la09.destroy', ':id') }}";
