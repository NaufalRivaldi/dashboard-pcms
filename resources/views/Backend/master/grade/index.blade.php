...
@section('card-button')
    <a href="{{ route('master.grade.create') }}" class="btn btn-info"><i class="ti-plus"></i> Add data</a>
@endsection
    ...
    new Vue({
        ...
        methods: {
            ...
            setStatus: function(type, id){
                // ----------------------------------------------------------------
                let url = "{{ route('master.grade.update.status', ['type' => ':type', 'id' => ':id']) }}";
            ...
            deleteData: function(id){
                // ----------------------------------------------------------------
                let url = "{{ route('master.grade.destroy', ':id') }}";
                url = url.replace(':id', id);
                // ----------------------------------------------------------------
                // Set confirm
                // ----------------------------------------------------------------
