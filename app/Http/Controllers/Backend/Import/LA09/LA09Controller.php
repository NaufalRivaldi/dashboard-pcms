...
class LA09Controller extends Controller
{
    ...
    public function importStore(Request $request)
    {
        ...
        try {
            ...
            // ----------------------------------------------------------------
            if(empty($cabang)){
                return redirect()->route('import.la09.index')->with('danger', __('Cabang tidak sesuai dengan user owner, silahkan masukkan data yang benar'));
            }
            // ----------------------------------------------------------------
            // Check siswa aktif
            // ----------------------------------------------------------------
            ...
            return redirect()->route('import.la09.index')->with('danger', __('label.FAIL_CREATE_MESSAGE'));
        }
        // --------------------------------------------------------------------
    }
    // ------------------------------------------------------------------------
