...
class LA07Controller extends Controller
{
    ...
    public function importStore(Request $request)
    {
        ...
        try {
            ...
            // ----------------------------------------------------------------
            if(empty($cabang)){
                return redirect()->route('import.la07.index')->with('danger', __('Cabang tidak sesuai dengan user owner, silahkan masukkan data yang benar'));
            }
            // ----------------------------------------------------------------
            // Check siswa aktif
            // ----------------------------------------------------------------
            ...
            if(empty($siswaAktif)){
                ...
                return redirect()->route('import.la07.index')->with('info', 'Data sudah ada dan sudah di approve');
            }
            // ----------------------------------------------------------------
            ...
            return redirect()->route('import.la07.index')->with('danger', __('label.FAIL_CREATE_MESSAGE'));
        }
        // --------------------------------------------------------------------
    }
    // ------------------------------------------------------------------------
