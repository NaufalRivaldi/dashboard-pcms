        ...
        switch ($param) {
            ...
            case 'datatable':
                ...
                $datatable = $datatable->addColumn('action', function($row){
                                    ...
                                    $button .= '<button class="btn btn-sm btn-warning btn-edit" data-id="'.$row->id.'" '.($row->siswa_aktif_pendidikan->status ? "disabled" : "").' data-toggle="modal" data-target="#modalEdit"><i class="ti-settings"></i></button>';
                                    $button .= '<button type="button" data-id="'.$row->id.'" class="btn btn-sm btn-danger btn-delete" '.($row->siswa_aktif_pendidikan->status ? "disabled" : "").'><i class="ti-trash"></i></button>';
                                    $button .= '</div>';
